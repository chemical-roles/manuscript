...
<small><em>
This manuscript
([permalink](https://chemical-roles.github.io/manuscript/v/003b4a2c40272b3ca177bdde6a831304c7a9f97b/))
was automatically generated
from [chemical-roles/manuscript@003b4a2](https://github.com/chemical-roles/manuscript/tree/003b4a2c40272b3ca177bdde6a831304c7a9f97b)
on June 30, 2020.
</em></small>
...
Table: Shape expression and predicate logic rules generalized for other relationships from Table {@tbl:table-1}. {#tbl:table-2}
...
For example, many ontologies such as GO and HPO are axiomatized using ChEBI [@doi:10.1186/1471-2164-14-513] for example, gliotoxin catabolism [@GO:2001309] has-input some gliotoxin [@CHEBI:5385].
...
A workflow has been developed using Dead Simple OWL Design Patterns (DOSDP) [@doi:10.1186/s13326-017-0126-0]​ and the Ontology Development Kit ​(ODK) [@https://github.com/INCATools/ontology-development-kit].
...
The Biological Expression Language (BEL) [@doi:10.1016/j.drudis.2013.12.011] is a domain specific language (DSL) for storing rich biomedical relations, supporting data integration [doi:10.1101/631812].
...
The internal BEL DSL in the PyBEL software package [@doi:10.1093/bioinformatics/btx660] was used to implement a conversion that is included with each export.
